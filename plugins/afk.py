...
from ERAVIBES.utils.afkdb import add_afk, is_afk, remove_afk
from ERAVIBES.utils.readable_time import get_readable_time


@app.on_message(filters.command(["afk", "brb", "fk", "rb"], prefixes=["/", "!", ".", "A", "B", "a", "b"]))
