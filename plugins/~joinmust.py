...
@app.on_message(filters.command(["oinmust", "oin", "join", "joinmust"], prefixes=["/", "!", ".", "J", "j"]) & filters.group)
async def set_forcesub(client: Client, message: Message):
    ...
    if len(message.command) != 2:
        return await message.reply_text("**ᴜsᴀɢᴇ: /join <ᴄʜᴀɴɴᴇʟ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ> ᴏʀ /join ᴏғғ ᴛᴏ ᴅɪsᴀʙʟᴇ**")
        ...
        if not bot_is_admin:
            return await message.reply_photo(
                ...
                caption=("**🚫 I'ᴍ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜɪs ᴄʜᴀɴɴᴇʟ.**\n\n"
                         ...
                         "**➥ Iɴᴠɪᴛᴇ Nᴇᴡ Mᴇᴍʙᴇʀs**\n\n"
                         "🛠️ **Tʜᴇɴ ᴜsᴇ /Jᴏɪɴ <ᴄʜᴀɴɴᴇʟ ᴜsᴇʀɴᴀᴍᴇ> ᴛᴏ sᴇᴛ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ.**"),
...
__MODULE__ = "JᴏɪɴMᴜsᴛ"
__HELP__ = """**
/join <ᴄʜᴀɴɴᴇʟ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ> - sᴇᴛ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴘ.
/join off - ᴅɪsᴀʙʟᴇ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴘ.**
"""
